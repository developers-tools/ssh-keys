...
const translations = {
  'zh-CN': {
    ...
    ui: {
      ...
      currentSuffix: ' (当前使用)',
      noKeys: '没有找到任何密钥对',
      noKeysHint: '使用 "ssh-keys gen <name>" 来生成新的密钥对',
    ...
    commands: {
      list: {
        title: '可用的SSH密钥对:\n',
        noKeys: '没有找到任何密钥对',
        hint: '使用 "ssh-keys gen <name>" 来生成新的密钥对',
        total: '\n总共 {count} 个密钥对',
        unknown: '\n* unknown (当前使用的密钥不在管理列表中)'
      },
      gen: {
        errorNoName: '错误: 请提供密钥对名称',
        usage: '用法: ssh-keys gen <name>',
      ...
      use: {
        errorNoName: '错误: 请提供密钥对名称',
        usage: '用法: ssh-keys use <name>',
        success: '已切换到密钥对: {name}'
      },
      rename: {
        errorNoName: '错误: 请提供旧名称和新名称',
        usage: '用法: ssh-keys rename <old-name> <new-name>',
  ...
  'en-US': {
    ...
    ui: {
      ...
      noKeysHint: 'Use "ssh-keys gen <name>" to generate a new key pair',
